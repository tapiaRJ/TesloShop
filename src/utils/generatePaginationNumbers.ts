...
export const generatePaginationNumbers = ( currentPage: number, totalPages: number ) => {
  ...
  // mostrar las primeras 3, puntos suspensivos, y las ultima 2
  if ( currentPage <= 3 ) {
    return [1,2,3,'...', totalPages -1 , totalPages ]; // [1,2,3, '...', 49,50];
  }

  // sila pagina actua esta entre las ultimas 3 paginas
  ...
  // mostrar la primea pagina, puntos suspensivos, la pagina actual y vecinos
  return [
    1,
    '...',
    currentPage - 1,
